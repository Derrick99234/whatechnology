...
const WhyChooseSection = () => {
  return (
    <div className="w-full bg-background text-foreground font-sans relative transition-colors duration-300">
      {/* Top Section */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 lg:py-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-4/5 max-w-md mx-auto lg:ml-0 border-8 border-border">
            <Image
              width={500}
              height={500}
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/10">
              <button className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
                <Play
                  className="fill-current text-foreground ml-1"
                  size={24}
                />
              </button>
            </div>
          ...
          <div className="absolute -top-6 -left-4 md:-left-12 bg-card p-4 rounded-2xl shadow-xl border border-border hidden md:block w-52 animate-bounce-slow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-slate-800 dark:text-white">+124.5%</p>
              </div>
            </div>
            <div className="flex items-end gap-1 h-12">
              <div className="flex-1 bg-secondary h-1/2 rounded-sm"></div>
              <div className="flex-1 bg-green-400 h-3/4 rounded-sm"></div>
              <div className="flex-1 bg-secondary h-1/3 rounded-sm"></div>
              <div className="flex-1 bg-foreground h-full rounded-sm"></div>
              <div className="flex-1 bg-secondary h-2/3 rounded-sm"></div>
            </div>
          </div>

          {/* Floating UI Card 2: Summary Circular Progress */}
          <div className="absolute -bottom-10 -right-4 md:-right-8 bg-card p-5 rounded-2xl shadow-2xl border border-border hidden md:block w-64">
            ...
            <div className="flex items-center gap-6">
              <div className="relative w-20 h-20">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-xs font-bold text-slate-800 dark:text-white">92%</span>
                </div>
              </div>
        ...
        >
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 bg-secondary border border-border rounded-full px-4 py-1.5">
              <span className="bg-foreground text-background text-[10px] font-black px-2 py-0.5 rounded-full uppercase italic">
                New
              </span>
            ...
            <h2 className="text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight">
              Why Choose <span>Whatechnology?</span>
            </h2>
          </div>
            ...
            {features.map((feature, idx) => (
              <div key={idx} className="flex gap-4 group">
                <div className="shrink-0">
                  <div className="w-6 h-6 rounded-full bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center group-hover:bg-green-500 transition-colors">
          ...
          {/* CTA Area */}
          <div className="flex flex-col sm:flex-row items-center gap-8 pt-4 border-t border-slate-100 dark:border-gray-800">
            <Link
              href={"/contact"}
              className="w-full sm:w-auto px-10 py-5 bg-primary hover:bg-green-600 text-primary-foreground font-black rounded-xl shadow-xl shadow-green-500/10 transition-all hover:-translate-y-1 active:scale-95"
            >
              Get Started Today
            </Link>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-slate-100 dark:border-gray-700">
                <Image
                  width={48}
                  height={48}
      ...
      <div className="relative mt-20">
        ...
        ></div>
        <section
          className="bg-background text-foreground py-32 px-6 relative"
        ...
        >
          ...
          >
            ...
            <p className="text-2xl md:text-4xl font-semibold leading-snug italic">
